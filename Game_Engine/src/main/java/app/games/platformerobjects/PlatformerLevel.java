...
public class PlatformerLevel extends Level {
    public PlatformerLevel(Game game1, int width, int height,String name){
        super(game1,new PhysicsEngineWithGravity(25.0),width,height,name);
        this.gameControls=new PlatformerMovement(game1,5.0);
        wallOffBoundary();
    }
    @Override
